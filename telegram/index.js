...
bot.on('message', (msg) => {
    ...
    http.get("https://api.telegram.org/bot"+token+"/getFile?file_id="+(!!msg.video?msg.video.file_id:msg.document.file_id), {json: true}, (err, res, body)=>{
        ...
        http.post({
            ...
            body:    `{"actions":[{"action":"download","source":"http://127.0.0.1:3000/files/assets/stacco.mp4"},{"action":"download","source":"http://127.0.0.1:3000/files/assets/logo_tg.png"},{"action":"download","source":"https://api.telegram.org/file/bot`+token+`/`+body.result.file_path+`"},{"action":"watermark","video":3,"logo":2},{"action":"concat","video":1,"outputLast":true}]}`
